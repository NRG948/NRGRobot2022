...
public class ClimberRotator extends SubsystemBase {
  ...
  @RobotPreferencesValue
  public static final DoubleValue kP = new DoubleValue("ClimberModule", "kP", 7);
  @RobotPreferencesValue
  ...
  public ClimberRotator() {
   // climberMotor = new TalonFX(ClimberConstants.kClimberRotatorMotor); // TODO: change this to a Falcon on CANbus
  }
